  ...
  static GameLevel generateOperationLevel(int levelId) {
    if (levelId == 1) {
      ...
      return GameLevel(
        ...
        targetValue: 65, // 10+2+3-5*2-4+6-2*2-10+5+2-3*2-4+1 = 65
        operations: {
      ...
      return GameLevel(
        ...
        targetValue: 24,
        operations: {
          const GridPoint(2, 3): const OperationCell(type: OperationType.add, operand: 8),
          ...
          const GridPoint(3, 1): const OperationCell(type: OperationType.add, operand: 30),
      ...
      return GameLevel(
        ...
        targetValue: 50,
        operations: {
          const GridPoint(0, 1): const OperationCell(type: OperationType.add, operand: 9),
        ...
        return GameLevel(
            ...
            operations: {
                ...
                const GridPoint(1, 1): const OperationCell(type: OperationType.divide, operand: 2),
                const GridPoint(1, 0): const OperationCell(type: OperationType.add, operand: 35),
                const GridPoint(2, 0): const OperationCell(type: OperationType.subtract, operand: 15),
                const GridPoint(2, 1): const OperationCell(type: OperationType.divide, operand: 5),
        ...
        return GameLevel(
            ...
            targetValue: 100,
            operations: {
                const GridPoint(1, 0): const OperationCell(type: OperationType.multiply, operand: 5),
                ...
                const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 25),
                const GridPoint(2, 3): const OperationCell(type: OperationType.divide, operand: 3),
                const GridPoint(1, 3): const OperationCell(type: OperationType.multiply, operand: 4),
                const GridPoint(0, 3): const OperationCell(type: OperationType.subtract, operand: 40),
                ...
                const GridPoint(2, 2): const OperationCell(type: OperationType.divide, operand: 5),
                const GridPoint(2, 1): const OperationCell(type: OperationType.multiply, operand: 10),
            },
        );
    } else if (levelId == 18) {
        ...
        return GameLevel(
            ...
            operations: {
                ...
                const GridPoint(1, 0): const OperationCell(type: OperationType.multiply, operand: 8),
                const GridPoint(0, 0): const OperationCell(type: OperationType.subtract, operand: 50),
                ...
                const GridPoint(3, 1): const OperationCell(type: OperationType.add, operand: 150),
                const GridPoint(3, 2): const OperationCell(type: OperationType.divide, operand: 5),
                const GridPoint(2, 2): const OperationCell(type: OperationType.multiply, operand: 4),
                const GridPoint(1, 2): const OperationCell(type: OperationType.subtract, operand: 60),
                const GridPoint(0, 2): const OperationCell(type: OperationType.add, operand: 80),
                const GridPoint(0, 3): const OperationCell(type: OperationType.divide, operand: 2),
                const GridPoint(1, 3): const OperationCell(type: OperationType.add, operand: 50),
        ...
        return GameLevel(
            ...
            startNode: const GridPoint(0, 3),
            startValue: 9,
            targetNode: const GridPoint(3, 0),
            targetValue: 81,
            operations: {
                const GridPoint(1, 3): const OperationCell(type: OperationType.multiply, operand: 9),
                const GridPoint(2, 3): const OperationCell(type: OperationType.divide, operand: 3),
                const GridPoint(3, 3): const OperationCell(type: OperationType.add, operand: 73),
                const GridPoint(3, 2): const OperationCell(type: OperationType.subtract, operand: 20),
                const GridPoint(2, 2): const OperationCell(type: OperationType.divide, operand: 4),
                const GridPoint(1, 2): const OperationCell(type: OperationType.multiply, operand: 5),
                ...
                const GridPoint(1, 1): const OperationCell(type: OperationType.divide, operand: 2),
                const GridPoint(2, 1): const OperationCell(type: OperationType.subtract, operand: 30),
                const GridPoint(3, 1): const OperationCell(type: OperationType.multiply, operand: 3),
                const GridPoint(3, 0): const OperationCell(type: OperationType.add, operand: 21),
                const GridPoint(2, 0): const OperationCell(type: OperationType.multiply, operand: 2),
            },
        );
    } else if (levelId == 20) {
        ...
        return GameLevel(
            ...
            targetValue: 77,
            operations: {
                const GridPoint(0, 1): const OperationCell(type: OperationType.multiply, operand: 11),
                const GridPoint(0, 2): const OperationCell(type: OperationType.divide, operand: 7),
                const GridPoint(0, 3): const OperationCell(type: OperationType.add, operand: 89),
                const GridPoint(1, 3): const OperationCell(type: OperationType.subtract, operand: 50),
                const GridPoint(2, 3): const OperationCell(type: OperationType.multiply, operand: 2),
                const GridPoint(3, 3): const OperationCell(type: OperationType.divide, operand: 5),
                const GridPoint(3, 2): const OperationCell(type: OperationType.add, operand: 100),
                ...
                const GridPoint(1, 0): const OperationCell(type: OperationType.add, operand: 62),
                const GridPoint(1, 1): const OperationCell(type: OperationType.subtract, operand: 20),
                const GridPoint(2, 1): const OperationCell(type: OperationType.multiply, operand: 2),
                const GridPoint(2, 2): const OperationCell(type: OperationType.divide, operand: 4),
                const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 50),
            },
        );
    }
