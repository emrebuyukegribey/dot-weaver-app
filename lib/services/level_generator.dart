...
class LevelGenerator {
  ...
  static GameLevel generateOperationLevel(int levelId) {
    if (levelId == 1) {
      ...
      // Level 5: 3x3 Introduction to larger grids
      return GameLevel(
        id: levelId,
        rows: 3,
        cols: 3,
        ...
        operations: {
          ...
          const GridPoint(2, 1): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(1, 1): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(0, 1): const OperationCell(type: OperationType.add, operand: 8),
          const GridPoint(0, 2): const OperationCell(type: OperationType.subtract, operand: 3),
          const GridPoint(1, 2): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 2): const OperationCell(type: OperationType.divide, operand: 3),
        },
      );
    } else if (levelId == 6) {
      // Level 6: 3x3 Snake Path
      return GameLevel(
        id: levelId,
        rows: 3,
        cols: 3,
        ...
        targetValue: 7,
        operations: {
          const GridPoint(0, 1): const OperationCell(type: OperationType.add, operand: 1),
          const GridPoint(0, 2): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(1, 2): const OperationCell(type: OperationType.subtract, operand: 3),
          const GridPoint(1, 1): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(1, 0): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(2, 0): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(2, 1): const OperationCell(type: OperationType.subtract, operand: 5),
          const GridPoint(2, 2): const OperationCell(type: OperationType.add, operand: 3),
        },
      );
    } else if (levelId == 7) {
      // Level 7: 3x3 Inward Spiral
      return GameLevel(
        id: levelId,
        rows: 3,
        cols: 3,
        timeLimit: 100,
        gameType: GameType.operationPath,
        dotPositions: {DotColor.green: [const GridPoint(2, 2), const GridPoint(2, 0)]},
        startNode: const GridPoint(2, 2),
        startValue: 10,
        targetNode: const GridPoint(2, 0),
        targetValue: 15,
        operations: {
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 2),
          ...
          const GridPoint(1, 0): const OperationCell(type: OperationType.subtract, operand: 5),
          const GridPoint(1, 1): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(2, 1): const OperationCell(type: OperationType.divide, operand: 3),
          const GridPoint(2, 0): const OperationCell(type: OperationType.add, operand: 9),
        },
      );
    } else if (levelId == 8) {
      // Level 8: 3x3 Zig-Zag
      return GameLevel(
        ...
        targetValue: 15,
        operations: {
          const GridPoint(1, 0): const OperationCell(type: OperationType.subtract, operand: 2),
          const GridPoint(2, 0): const OperationCell(type: OperationType.divide, operand: 3),
          const GridPoint(2, 1): const OperationCell(type: OperationType.add, operand: 9),
          const GridPoint(1, 1): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(0, 1): const OperationCell(type: OperationType.subtract, operand: 5),
          const GridPoint(0, 2): const OperationCell(type: OperationType.divide, operand: 5),
      ...
      return GameLevel(
        ...
        timeLimit: 120,
        gameType: GameType.operationPath,
        dotPositions: {DotColor.green: [const GridPoint(1, 1), const GridPoint(2, 0)]},
        startNode: const GridPoint(1, 1),
        startValue: 3,
        targetNode: const GridPoint(2, 0),
        targetValue: 10,
        operations: {
          const GridPoint(1, 0): const OperationCell(type: OperationType.multiply, operand: 4),
          const GridPoint(0, 0): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(0, 1): const OperationCell(type: OperationType.divide, operand: 5),
          const GridPoint(0, 2): const OperationCell(type: OperationType.add, operand: 7),
          const GridPoint(1, 2): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 2): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(2, 1): const OperationCell(type: OperationType.add, operand: 5),
          const GridPoint(2, 0): const OperationCell(type: OperationType.subtract, operand: 5),
        },
      );
    } else if (levelId == 10) {
      // Level 10: 3x3 Multi-Step
      return GameLevel(
        id: levelId,
        rows: 3,
        cols: 3,
        timeLimit: 130,
        gameType: GameType.operationPath,
        dotPositions: {DotColor.green: [const GridPoint(2, 0), const GridPoint(0, 0)]},
        startNode: const GridPoint(2, 0),
        startValue: 100,
        targetNode: const GridPoint(0, 0),
        targetValue: 8,
        operations: {
          const GridPoint(2, 1): const OperationCell(type: OperationType.divide, operand: 10),
          const GridPoint(2, 2): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(1, 2): const OperationCell(type: OperationType.subtract, operand: 5),
          const GridPoint(0, 2): const OperationCell(type: OperationType.add, operand: 1),
          const GridPoint(0, 1): const OperationCell(type: OperationType.divide, operand: 4),
          const GridPoint(1, 1): const OperationCell(type: OperationType.add, operand: 6),
          const GridPoint(1, 0): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(0, 0): const OperationCell(type: OperationType.subtract, operand: 12),
        },
      );
    } else if (levelId == 11) {
      // Level 11: 4x4 Snake Path
      return GameLevel(
        id: levelId,
        rows: 4,
        cols: 4,
        timeLimit: 150,
        gameType: GameType.operationPath,
        dotPositions: {DotColor.green: [const GridPoint(0, 0), const GridPoint(3, 0)]},
        startNode: const GridPoint(0, 0),
        startValue: 10,
        ...
        operations: {
          ...
          const GridPoint(0, 3): const OperationCell(type: OperationType.subtract, operand: 5),
          ...
          const GridPoint(2, 0): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 1): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(2, 2): const OperationCell(type: OperationType.add, operand: 5),
          const GridPoint(2, 3): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 3),
          const GridPoint(3, 2): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(3, 1): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(3, 0): const OperationCell(type: OperationType.add, operand: 1),
        },
      );
    } else if (levelId == 12) {
      // Level 12: 4x4 Spiral
      return GameLevel(
        ...
        timeLimit: 160,
        gameType: GameType.operationPath,
        dotPositions: {DotColor.green: [const GridPoint(0, 0), const GridPoint(2, 1)]},
        startNode: const GridPoint(0, 0),
        startValue: 5,
        targetNode: const GridPoint(2, 1),
        targetValue: 29,
        operations: {
          const GridPoint(0, 1): const OperationCell(type: OperationType.add, operand: 5),
          const GridPoint(0, 2): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(0, 3): const OperationCell(type: OperationType.subtract, operand: 7),
          const GridPoint(1, 3): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 3): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(3, 3): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(3, 2): const OperationCell(type: OperationType.add, operand: 4),
          ...
          const GridPoint(2, 0): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(1, 0): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(1, 1): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 9),
          const GridPoint(2, 2): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(2, 1): const OperationCell(type: OperationType.subtract, operand: 5),
        },
      );
    } else if (levelId == 13) {
      // Level 13: 4x4 Columns Zig-Zag
      return GameLevel(
        id: levelId,
        rows: 4,
        cols: 4,
        timeLimit: 170,
        gameType: GameType.operationPath,
        dotPositions: {DotColor.green: [const GridPoint(0, 0), const GridPoint(0, 3)]},
        startNode: const GridPoint(0, 0),
        startValue: 100,
        targetNode: const GridPoint(0, 3),
        targetValue: 80,
        operations: {
          ...
          const GridPoint(3, 0): const OperationCell(type: OperationType.add, operand: 20),
          const GridPoint(3, 1): const OperationCell(type: OperationType.add, operand: 11),
          const GridPoint(2, 1): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(1, 1): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(0, 1): const OperationCell(type: OperationType.subtract, operand: 5),
          const GridPoint(0, 2): const OperationCell(type: OperationType.divide, operand: 5),
          const GridPoint(1, 2): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(2, 2): const OperationCell(type: OperationType.add, operand: 7),
          const GridPoint(3, 2): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(3, 3): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(2, 3): const OperationCell(type: OperationType.add, operand: 15),
          const GridPoint(1, 3): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(0, 3): const OperationCell(type: OperationType.subtract, operand: 30),
        },
      );
    } else if (levelId == 14) {
      // Level 14: 4x4 Random-ish Walk
      return GameLevel(
        id: levelId,
        rows: 4,
        cols: 4,
        ...
        operations: {
          ...
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 5),
          const GridPoint(1, 1): const OperationCell(type: OperationType.add, operand: 0),
          const GridPoint(2, 1): const OperationCell(type: OperationType.subtract, operand: 20),
          const GridPoint(3, 1): const OperationCell(type: OperationType.add, operand: 13),
          const GridPoint(3, 0): const OperationCell(type: OperationType.divide, operand: 4),
          const GridPoint(2, 0): const OperationCell(type: OperationType.multiply, operand: 5),
          const GridPoint(1, 0): const OperationCell(type: OperationType.subtract, operand: 15),
          const GridPoint(0, 0): const OperationCell(type: OperationType.add, operand: 13), 
          const GridPoint(0, 1): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(3, 2): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 5),
        },
      );
    } else if (levelId == 15) {
      // Level 15: 4x4 Progressively Large
      return GameLevel(
        id: levelId,
        rows: 4,
        cols: 4,
        ...
        startNode: const GridPoint(1, 1),
        startValue: 1,
        targetNode: const GridPoint(2, 3),
        targetValue: 45,
        operations: {
          const GridPoint(0, 1): const OperationCell(type: OperationType.add, operand: 8),
          const GridPoint(0, 0): const OperationCell(type: OperationType.multiply, operand: 5),
          const GridPoint(1, 0): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(2, 0): const OperationCell(type: OperationType.add, operand: 25),
          ...
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 20),
          const GridPoint(0, 2): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(0, 3): const OperationCell(type: OperationType.subtract, operand: 80),
          const GridPoint(1, 3): const OperationCell(type: OperationType.add, operand: 60),
          const GridPoint(3, 3): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(2, 2): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(3, 2): const OperationCell(type: OperationType.subtract, operand: 30),
          const GridPoint(2, 3): const OperationCell(type: OperationType.add, operand: 20),
        },
      );
    } else if (levelId == 16) {
        // Level 16: 4x4 Multi-Divide
        return GameLevel(
            id: levelId,
            rows: 4,
            cols: 4,
            timeLimit: 200,
            gameType: GameType.operationPath,
            dotPositions: {DotColor.green: [const GridPoint(0, 0), const GridPoint(3, 2)]},
            startNode: const GridPoint(0, 0),
            startValue: 120,
            targetNode: const GridPoint(3, 2),
            targetValue: 44,
            operations: {
                ...
                const GridPoint(0, 3): const OperationCell(type: OperationType.divide, operand: 5),
                const GridPoint(1, 3): const OperationCell(type: OperationType.multiply, operand: 4),
                const GridPoint(1, 2): const OperationCell(type: OperationType.subtract, operand: 20),
                const GridPoint(1, 1): const OperationCell(type: OperationType.divide, operand: 3),
                const GridPoint(1, 0): const OperationCell(type: OperationType.add, operand: 13),
                const GridPoint(2, 0): const OperationCell(type: OperationType.subtract, operand: 15),
                const GridPoint(2, 1): const OperationCell(type: OperationType.divide, operand: 3),
                const GridPoint(2, 2): const OperationCell(type: OperationType.multiply, operand: 10),
                const GridPoint(2, 3): const OperationCell(type: OperationType.subtract, operand: 40),
                const GridPoint(3, 3): const OperationCell(type: OperationType.add, operand: 0),
                const GridPoint(3, 2): const OperationCell(type: OperationType.add, operand: 20),
        ...
        return GameLevel(
            ...
            timeLimit: 210,
            gameType: GameType.operationPath,
            dotPositions: {DotColor.green: [const GridPoint(0, 0), const GridPoint(1, 1)]},
            startNode: const GridPoint(0, 0),
            startValue: 10,
            targetNode: const GridPoint(2, 1),
            targetValue: 100,
            operations: {
                const GridPoint(1, 0): const OperationCell(type: OperationType.add, operand: 5),
                const GridPoint(2, 0): const OperationCell(type: OperationType.subtract, operand: 25),
                const GridPoint(3, 0): const OperationCell(type: OperationType.add, operand: 75),
                const GridPoint(3, 1): const OperationCell(type: OperationType.divide, operand: 3),
                const GridPoint(3, 2): const OperationCell(type: OperationType.add, operand: 50),
                const GridPoint(3, 3): const OperationCell(type: OperationType.add, operand: 23),
                const GridPoint(2, 3): const OperationCell(type: OperationType.divide, operand: 25),
                const GridPoint(1, 3): const OperationCell(type: OperationType.multiply, operand: 4),
                const GridPoint(0, 3): const OperationCell(type: OperationType.subtract, operand: 10),
                const GridPoint(0, 2): const OperationCell(type: OperationType.add, operand: 20),
                const GridPoint(0, 1): const OperationCell(type: OperationType.multiply, operand: 2),
                const GridPoint(2, 1): const OperationCell(type: OperationType.divide, operand: 8),
                const GridPoint(1, 2): const OperationCell(type: OperationType.subtract, operand: 20),
                const GridPoint(2, 2): const OperationCell(type: OperationType.divide, operand: 2),
                const GridPoint(1, 1): const OperationCell(type: OperationType.multiply, operand: 10),
            },
        );
    } else if (levelId == 18) {
        // Level 18: 4x4 The Centurion
        return GameLevel(
            id: levelId,
            rows: 4,
            cols: 4,
            timeLimit: 220,
            gameType: GameType.operationPath,
            dotPositions: {DotColor.green: [const GridPoint(3, 0), const GridPoint(0, 3)]},
            startNode: const GridPoint(3, 0),
            startValue: 8,
            targetNode: const GridPoint(1, 3),
            targetValue: 12,
            operations: {
                const GridPoint(2, 0): const OperationCell(type: OperationType.multiply, operand: 3),
                const GridPoint(2, 1): const OperationCell(type: OperationType.subtract, operand: 4),
                const GridPoint(3, 1): const OperationCell(type: OperationType.divide, operand: 2),
                const GridPoint(3, 2): const OperationCell(type: OperationType.divide, operand: 5),
                const GridPoint(3, 3): const OperationCell(type: OperationType.add, operand: 3),
                const GridPoint(1, 1): const OperationCell(type: OperationType.multiply, operand: 2),
                const GridPoint(2, 2): const OperationCell(type: OperationType.multiply, operand: 8),
                const GridPoint(1, 2): const OperationCell(type: OperationType.subtract, operand: 60),
                ...
                const GridPoint(0, 0): const OperationCell(type: OperationType.subtract, operand: 15),
                const GridPoint(0, 1): const OperationCell(type: OperationType.subtract, operand: 3),
                const GridPoint(0, 2): const OperationCell(type: OperationType.subtract, operand: 7),
                const GridPoint(0, 3): const OperationCell(type: OperationType.subtract, operand: 1),
                const GridPoint(1, 3): const OperationCell(type: OperationType.divide, operand: 2),
            },
        );
    } else if (levelId == 19) {
        // Level 19: 4x4 Precision Math
        return GameLevel(
            id: levelId,
            rows: 4,
            cols: 4,
            timeLimit: 230,
            gameType: GameType.operationPath,
            dotPositions: {DotColor.green: [const GridPoint(0, 3), const GridPoint(3, 0)]},
            ...
            operations: {
                ...
                const GridPoint(0, 3): const OperationCell(type: OperationType.multiply, operand: 5),
                const GridPoint(1, 3): const OperationCell(type: OperationType.add, operand: 5),
                const GridPoint(2, 3): const OperationCell(type: OperationType.divide, operand: 20),
                const GridPoint(3, 3): const OperationCell(type: OperationType.add, operand: 13),
                ...
                const GridPoint(2, 0): const OperationCell(type: OperationType.multiply, operand: 2),
                const GridPoint(1, 0): const OperationCell(type: OperationType.add, operand: 80),
                const GridPoint(0, 0): const OperationCell(type: OperationType.divide, operand: 2),
                const GridPoint(0, 1): const OperationCell(type: OperationType.subtract, operand: 17),                   
                const GridPoint(1, 1): const OperationCell(type: OperationType.add, operand: 7),
            },
        );
    } else if (levelId == 20) {
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(1, 1): const OperationCell(type: OperationType.subtract, operand: 6),
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(1, 3): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(1, 4): const OperationCell(type: OperationType.subtract, operand: 9),
          const GridPoint(2, 0): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 1): const OperationCell(type: OperationType.add, operand: 1),
          const GridPoint(2, 2): const OperationCell(type: OperationType.subtract, operand: 8),
          const GridPoint(2, 3): const OperationCell(type: OperationType.add, operand: 6),
          ...
          const GridPoint(3, 1): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(3, 2): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(3, 4): const OperationCell(type: OperationType.add, operand: 5),
          ...
          const GridPoint(4, 4): const OperationCell(type: OperationType.add, operand: 3),
        },
      );
    } else if (levelId == 23) {
      ...
      return GameLevel(
        ...
        targetValue: 44,
        operations: {
          const GridPoint(0, 0): const OperationCell(type: OperationType.add, operand: 8),
          const GridPoint(0, 1): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(0, 2): const OperationCell(type: OperationType.subtract, operand: 12),
          const GridPoint(0, 3): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(1, 0): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(1, 1): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 6),
          const GridPoint(1, 3): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(1, 4): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(2, 0): const OperationCell(type: OperationType.subtract, operand: 8),
          const GridPoint(2, 1): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(2, 2): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(2, 3): const OperationCell(type: OperationType.divide, operand: 4),
          const GridPoint(2, 4): const OperationCell(type: OperationType.subtract, operand: 12),
          const GridPoint(3, 0): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(3, 1): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(3, 2): const OperationCell(type: OperationType.subtract, operand: 1),
          const GridPoint(3, 3): const OperationCell(type: OperationType.add, operand: 6),
          ...
          const GridPoint(4, 2): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(4, 3): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(4, 4): const OperationCell(type: OperationType.add, operand: 5),
        },
      );
    } else if (levelId == 24) {
      ...
      return GameLevel(
        ...
        operations: {
          const GridPoint(0, 1): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(0, 2): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(0, 3): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(0, 4): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(1, 0): const OperationCell(type: OperationType.add, operand: 6),
          const GridPoint(1, 1): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(1, 2): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(1, 3): const OperationCell(type: OperationType.add, operand: -6),
          const GridPoint(1, 4): const OperationCell(type: OperationType.subtract, operand: 10),
          ...
          const GridPoint(2, 2): const OperationCell(type: OperationType.add, operand: 0),
          const GridPoint(2, 3): const OperationCell(type: OperationType.subtract, operand: 8),
          const GridPoint(2, 4): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(3, 0): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(3, 1): const OperationCell(type: OperationType.subtract, operand: 12),
          const GridPoint(3, 2): const OperationCell(type: OperationType.add, operand: 8),
          const GridPoint(3, 3): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(3, 4): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(4, 0): const OperationCell(type: OperationType.add, operand: 6),
          ...
          const GridPoint(4, 3): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(4, 4): const OperationCell(type: OperationType.subtract, operand: 8),
        },
      );
    } else if (levelId == 26) {
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(1, 4): const OperationCell(type: OperationType.add, operand: 5),
          const GridPoint(2, 0): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 1): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(2, 2): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(2, 3): const OperationCell(type: OperationType.multiply, operand: 2),
          ...
          const GridPoint(3, 4): const OperationCell(type: OperationType.subtract, operand: 5),
          const GridPoint(4, 0): const OperationCell(type: OperationType.add, operand: 7),
          const GridPoint(4, 1): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(4, 2): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(4, 3): const OperationCell(type: OperationType.subtract, operand: 2),
      ...
      return GameLevel(
        ...
        operations: {
          const GridPoint(0, 0): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(0, 1): const OperationCell(type: OperationType.subtract, operand: 14),
          const GridPoint(0, 2): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(0, 3): const OperationCell(type: OperationType.add, operand: 5),
          const GridPoint(0, 4): const OperationCell(type: OperationType.divide, operand: 3),
          const GridPoint(1, 0): const OperationCell(type: OperationType.subtract, operand: 6),
          const GridPoint(1, 1): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(1, 3): const OperationCell(type: OperationType.subtract, operand: 12),
          const GridPoint(1, 4): const OperationCell(type: OperationType.subtract, operand: 24 ),
          const GridPoint(2, 0): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 1): const OperationCell(type: OperationType.add, operand: 8),
          ...
          const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 11),
          const GridPoint(3, 4): const OperationCell(type: OperationType.subtract, operand: 3),
          const GridPoint(4, 0): const OperationCell(type: OperationType.add, operand: 15),
          const GridPoint(4, 1): const OperationCell(type: OperationType.subtract, operand: 2),
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(1, 0): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(1, 1): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 8),
          const GridPoint(1, 3): const OperationCell(type: OperationType.add, operand: 5),
          ...
          const GridPoint(2, 4): const OperationCell(type: OperationType.subtract, operand: 40),
          const GridPoint(3, 0): const OperationCell(type: OperationType.subtract, operand: 20),
          const GridPoint(3, 1): const OperationCell(type: OperationType.add, operand: 25),
          const GridPoint(3, 2): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(3, 4): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(4, 0): const OperationCell(type: OperationType.add, operand: 1),
          const GridPoint(4, 1): const OperationCell(type: OperationType.subtract, operand: 30),
          const GridPoint(4, 2): const OperationCell(type: OperationType.subtract, operand: 20),
          const GridPoint(4, 3): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(4, 4): const OperationCell(type: OperationType.add, operand: 1),
        },
      );
    } else if (levelId == 29) {
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(0, 4): const OperationCell(type: OperationType.add, operand: 5),
          const GridPoint(1, 0): const OperationCell(type: OperationType.add, operand: 20),
          const GridPoint(1, 1): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(1, 2): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(1, 3): const OperationCell(type: OperationType.add, operand: 2),
          ...
          const GridPoint(2, 3): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 4): const OperationCell(type: OperationType.subtract, operand: 30),
          const GridPoint(3, 0): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(3, 1): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(3, 2): const OperationCell(type: OperationType.add, operand: 6),
          const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 40),
          const GridPoint(3, 4): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(4, 0): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(4, 1): const OperationCell(type: OperationType.add, operand: 5),
          const GridPoint(4, 2): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(4, 3): const OperationCell(type: OperationType.add, operand: 3),
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(0, 3): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(0, 4): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(1, 0): const OperationCell(type: OperationType.divide, operand: 4),
          const GridPoint(1, 1): const OperationCell(type: OperationType.add, operand: 5),
          const GridPoint(1, 2): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(1, 3): const OperationCell(type: OperationType.subtract, operand: 8),
          const GridPoint(1, 4): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(2, 0): const OperationCell(type: OperationType.add, operand: 16),
          const GridPoint(2, 1): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 2): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(2, 3): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(2, 4): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(3, 0): const OperationCell(type: OperationType.subtract, operand: 8),
          const GridPoint(3, 1): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(3, 2): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(3, 3): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(3, 4): const OperationCell(type: OperationType.divide, operand: 4),
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(2, 0): const OperationCell(type: OperationType.divide, operand: 4),
          const GridPoint(2, 1): const OperationCell(type: OperationType.subtract, operand: 20),
          const GridPoint(2, 2): const OperationCell(type: OperationType.divide, operand: 2),
          ...
          const GridPoint(3, 0): const OperationCell(type: OperationType.divide, operand: 4),
          const GridPoint(3, 1): const OperationCell(type: OperationType.subtract, operand: 10),
          ...
          const GridPoint(4, 2): const OperationCell(type: OperationType.subtract, operand: 3),
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(0, 4): const OperationCell(type: OperationType.add, operand: 8),
          const GridPoint(1, 0): const OperationCell(type: OperationType.add, operand: 20),
          const GridPoint(1, 1): const OperationCell(type: OperationType.subtract, operand: 2),
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 10),
          const GridPoint(1, 3): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(1, 4): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(2, 0): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(2, 1): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(2, 3): const OperationCell(type: OperationType.subtract, operand: 6),
          const GridPoint(2, 4): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(3, 0): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(3, 1): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(3, 2): const OperationCell(type: OperationType.divide, operand: 6),
          const GridPoint(3, 3): const OperationCell(type: OperationType.divide, operand: 4),
          const GridPoint(3, 4): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(4, 0): const OperationCell(type: OperationType.subtract, operand: 32),
          const GridPoint(4, 1): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(4, 2): const OperationCell(type: OperationType.subtract, operand: 8),
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(1, 4): const OperationCell(type: OperationType.subtract, operand: 14),
          ...
          const GridPoint(3, 1): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(3, 2): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 7),
          const GridPoint(3, 4): const OperationCell(type: OperationType.divide, operand: 2),
          ...
          const GridPoint(4, 2): const OperationCell(type: OperationType.divide, operand: 10),
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(0, 4): const OperationCell(type: OperationType.subtract, operand: 8),
          const GridPoint(1, 0): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(1, 1): const OperationCell(type: OperationType.add, operand: 8),
          const GridPoint(1, 2): const OperationCell(type: OperationType.add, operand: 6),
          const GridPoint(1, 3): const OperationCell(type: OperationType.divide, operand: 7),
          const GridPoint(1, 4): const OperationCell(type: OperationType.add, operand: 4),
          const GridPoint(2, 0): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(2, 1): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(2, 2): const OperationCell(type: OperationType.add, operand: 16),
          const GridPoint(2, 3): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(2, 4): const OperationCell(type: OperationType.subtract, operand: 12),
          const GridPoint(3, 0): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(3, 1): const OperationCell(type: OperationType.divide, operand: 3),
          const GridPoint(3, 2): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 5),
          const GridPoint(3, 4): const OperationCell(type: OperationType.add, operand: 3),
          const GridPoint(4, 0): const OperationCell(type: OperationType.subtract, operand: 4),
          const GridPoint(4, 1): const OperationCell(type: OperationType.add, operand: 8),
          const GridPoint(4, 2): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(4, 3): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(4, 4): const OperationCell(type: OperationType.divide, operand: 2),
        },
      ...
      return GameLevel(
        ...
        operations: {
          ...
          const GridPoint(1, 2): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(1, 3): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(1, 4): const OperationCell(type: OperationType.add, operand: 6),
          const GridPoint(2, 0): const OperationCell(type: OperationType.subtract, operand: 16),
          const GridPoint(2, 1): const OperationCell(type: OperationType.add, operand: 12),
          const GridPoint(2, 2): const OperationCell(type: OperationType.divide, operand: 2),
          const GridPoint(2, 3): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(2, 4): const OperationCell(type: OperationType.subtract, operand: 10),
          const GridPoint(3, 0): const OperationCell(type: OperationType.multiply, operand: 2),
          const GridPoint(3, 1): const OperationCell(type: OperationType.subtract, operand: 2),
          const GridPoint(3, 2): const OperationCell(type: OperationType.add, operand: 14),
          const GridPoint(3, 3): const OperationCell(type: OperationType.subtract, operand: 5),
          const GridPoint(3, 4): const OperationCell(type: OperationType.multiply, operand: 3),
          const GridPoint(4, 1): const OperationCell(type: OperationType.add, operand: 2),
          const GridPoint(4, 2): const OperationCell(type: OperationType.add, operand: 4),
